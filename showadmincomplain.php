...
$con = mysqli_connect($server_name, $mysql_user, $mysql_pass, $db_name);
 ...
 if(!$con){
    ...
    echo "hello";
     ...
     $query = "SELECT * FROM register_complain ORDER BY complainid DESC";
  ...
  <!--<![endif]-->
    ...
    <li><ul class="dashboard-menu nav nav-list collapse in">
        ...
        <li><ul class="accounts-menu nav nav-list collapse">
            <li ><a href=""><span class="fa fa-caret-right"></span> Approved Accounts </a></li>
        ...
        <?php
            ...
            ?>
                <tr>
                    ...
                    <td><button type = "submit" value = "<?php $row['complainid'] ?>" >More</button></td>
                </tr>
