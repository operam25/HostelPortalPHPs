...
$con = mysqli_connect($server_name, $mysql_user, $mysql_pass, $db_name);
 ...
 if(!$con){
    ...
    echo "hello";
     ...
     $query = "SELECT * FROM user_info WHERE status = 'In Process' ";
  ...
  <!--<![endif]-->
    ...
    <li><ul class="dashboard-menu nav nav-list collapse in">
        ...
        <li><ul class="accounts-menu nav nav-list collapse">
            ...
            <li ><a href=""><span class="fa fa-caret-right"></span> Pending Accounts <span class="label label-info"> +3 </span></a></li>
        ...
        <?php
            ...
            ?>
                <tr>
                    ...
                    <td><button type = "Reject" >Reject</button></td>
                </tr>
